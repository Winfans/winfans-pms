...
<div class="layui-side">
        ...
        <ul class="layui-nav layui-nav-tree">
            <li class="layui-nav-item layui-nav-itemed system-management">
                ...
                <ul class="layui-nav-child">
                    <li><a href="index" id="index">首页</a></li>
                    <li><a href="findAllProject" id="project-management">项目管理</a></li>
                    <li><a href="findAllUser" id="user-management">用户管理</a></li>
                    <li><a href="findAllProjectUser" id="team-management">团队管理</a></li>
                </ul>
            </li>
    ...
    <script>
        if (window.location.href.includes("Project") ) {
            ...
            document.getElementById('index').className = "layui-this"
        }
    </script>
</div>
