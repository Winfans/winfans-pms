            ...
            <script type="text/html" id="left-demo">
                <form class="layui-form" lay-filter="user-form-filter">
                    <div class="layui-input-inline search-input">
                        <input type="text" name="searchUsername" placeholder="请输入用户名" autocomplete="off"
                               class="layui-input">
                    </div>
...
<script>
    ...
    !function () {
        ...
        table.render({
            elem: '#user-table',
            url: getRootPath() + '/admin2/findAllUserByUsername?username='+ window.location.href.split("?")[1].split("=")[1], // 数据接口
        ...
        table.on('toolbar(user-filter)', function (obj) {
            ...
            switch (obj.event) {
                ...
                case 'del':
                    ...
                    break;
                case 'search':
                    window.location.href = getRootPath() + "/admin2/searchUser.jsp?username=" + formData.searchUsername;
                    break;
                default:
                    break;
            }
