        ...
        <form class="layui-form" action="updateUser">
            ...
            <div class="layui-form-item layui-form-text">
                ...
                <div class="layui-input-block" id="edit-personalized-signature">
                    <textarea name="personalizedSignature" placeholder="请输入内容" class="layui-textarea"><%=user.getPersonalizedSignature().trim()%></textarea>
                </div>
            </div>
            <%
                    }
        ...
        layer.open({
                ...
                success: function (layero, index) {
                   ...
                   %>
                    ...
                    <%--兴趣处理--%>
                    <%
                    String interestStr = userTemp.getInterest();
                    ...
                    <%--管理员处理--%>
                    <%
                    Integer isAdmin = userTemp.getIsAdmin();
                    if (isAdmin == 1) {
                    %>
