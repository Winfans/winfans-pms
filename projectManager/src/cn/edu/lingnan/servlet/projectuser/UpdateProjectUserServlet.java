 ...
 */
@WebServlet(urlPatterns = {"/admin/updateProjectUser", "/admin2/updateProjectUser"})
public class UpdateProjectUserServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (req.getRequestURI().contains("/admin/updateProjectUser")) {
